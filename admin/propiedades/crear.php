...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($errores)) {
    ...
    // s: titulo, s: precio, s: nombreImagen, s: descripcion, i: habitaciones, i: wc, i: estacionamiento, s: creado, i: vendedores_id
    mysqli_stmt_bind_param($stmt, "ssssiiisi", $titulo, $precio, $nombreImagen, $descripcion, $habitaciones, $wc, $estacionamiento, $creado, $vendedores_id);
